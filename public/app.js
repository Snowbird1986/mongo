$.get("/scrape").then(function(data) {
  ...
  $.getJSON("/articles", function(data) {
    ...
    for (var i = 0; i < data.length; i++) {
      ...
      $("#articles").append("<div data-id='" + data[i]._id + "' class='articleBlock'><h1>" + data[i].title + "</h1><br />"+data[i].summary+"<br /><br /><a href=http://www.espn.com"+data[i].link+" target='_blank'>http://www.espn.com" + data[i].link + "</a></div>");
    }
  });
})
